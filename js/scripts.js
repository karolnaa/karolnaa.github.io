...
displayResults1 = () => {
  ...
  modalBody.innerHTML = `Ups pomyliły mi sie kierunki chyba napisałem na odwrót jak kamil ślimak... Poszukaj na internecie jak odwrócić tekst.. <br> ćawodokdô eis ic adu eżom i )ezsip einōrts an kaj kat pti iicsa,edocinu,xeh,lru .pn( hcadotem hcynad w imaredoked/imaredokne z nōrts ćakuzsdo jubōrpS .ŏinawodok ytroz ezsjyinralupopjon mōs jak ynōrts od knil ej jekuT .aredokne ćyżu zsisum ćawodokdô og yboC .knil ynawodokaz ej jyżinōP .etsorp ekat yin oT.
  <br>https://www.javatpoint.com/types-of-encoding-techniques
  <BR> TAJNY kod!:
  <BR> a2Fyb2xrYXJvbC5tZS9zemFsb255a29rb3MyOA==`;
  modal.show();
};
